...
public class HibernateInstructorDao implements InstructorDao {
	...
	public void add(Instructor instructor) {
		System.out.println("Hibernate kullanarak veritabanına eklendi: " + instructor.getFirstName() + " " + instructor.getLastName() + " " + instructor.getAge() + " " + instructor.getPhoto());
	...
	public void update(Instructor instructor) {
		System.out.println("Hibernate kullanarak veritabanında güncellendi: " + instructor.getFirstName() + " " + instructor.getLastName() + " " + instructor.getAge() + " " + instructor.getPhoto());
